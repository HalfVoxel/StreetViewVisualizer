...
namespace Pathfinding.Util {
	...
	public class RetainedGizmos {
		...
		public class Builder : IAstarPooledObject {
			...
			public void DrawCircle (Vector3 center, float radius, Color color, float startAngle = 0f, float endAngle = 2*Mathf.PI) {
				int steps = 40;
				...
				Vector3 prev = new Vector3(Mathf.Cos(startAngle)*radius, Mathf.Sin(startAngle)*radius, 0);
